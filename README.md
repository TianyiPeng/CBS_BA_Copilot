# 🦙📚 Columbia Business Analytics Add-in Copilot

Columbia Business Analytics Add-in Copilot is an AI-powered chatbot designed to answer questions about Columbia Business Analytics Add-in. It leverages the capabilities of OpenAI's GPT-4o and LlamaIndex to provide accurate and contextually relevant responses based on the data it has been trained on.
